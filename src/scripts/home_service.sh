...
xterm -e "source /opt/ros/noetic/setup.bash; source $CATKIN_WS/devel/setup.bash; rosrun rviz rviz -d $CATKIN_WS/src/rvizConfig/home_service.rviz" &
sleep 5

# 4. Run the pick_objects node (sends goals to move_base)
xterm -e "source /opt/ros/noetic/setup.bash; source $CATKIN_WS/devel/setup.bash; rosrun pick_objects pick_objects" &
sleep 2
